...
const TermsofService = () => {
  return (
    <div style={{
      ...
      <h2>Cookie Policy</h2>
      <p>
        Cookies and other Identifiers consist of portions of code installed in the browser that assist the Owner in providing the Service according to the purposes described. Some of the purposes for which Cookies are installed may also require the User&aposs consent.
...
This Application uses Cookies to save the User&aposs session and to carry out other activities that are strictly necessary for the operation of this Application, for example in relation to the distribution of traffic.

Activity regarding the saving of preferences, optimization, and statistics.
This Application uses Cookies to save browsing preferences and to optimize the User&aposs browsing experience. Among these Cookies are, for example, those used for the setting of language and currency preferences or for the management of first party statistics employed directly by the Owner of the site.
...
AdMob is an advertising service provided by AdMob Google Inc.In order to understand Google&aposs use of Data, consult Google&aposs partner policy.
...
This integration of Google Analytics anonymizes your IP address. It works by shortening Users&apos IP addresses within member states of the European Union or in other contracting states to the Agreement on the European Economic Area. Only in exceptional cases will the complete IP address be sent to a Google server and shortened within the US.
...
This type of service allows this Application to display advertisments for third party products or services. Ads can be displayed either as advertising links or as banners using various kinds of graphics. Clicks on the icon or banner posted on the Application are tracked by the third-party services listed below, and are shared with this Application. For details of which data are collected, please refer to the privacy policy of each service.
...
eBay Partner Network è un servizio di affiliazione commerciale fornito da eBay, Inc.
...
Rakuten Marketing Affiliate is a banner commercial affiliation service provided by Rakuten Marketing Europe Ltd.

Personal Data collected: Cookies, Universally unique identifier (UUID) and Usage Data.
...
Personal Data collected: Cookies, email address, geographic position, language, unique device identifiers for advertising (Google Advertiser ID or IDFA, for example), Usage Data and various types of Data as specified in the privacy policy of the service.
...
Users can opt out of Google&aposs use of cookies for ads personalization by visiting Google&aposs Ads Settings.
...
This type of service analyzes the traffic of this Application, potentially containing Users&apos Personal Data, with the purpose of filtering it from parts of traffic, messages and content that are recognized as SPAM.
...
With regard to Cookies installed by third parties, Users can manage their preferences and withdrawal of their consent by clicking the related opt-out link (if provided), by using the means provided in the third party&aposs privacy policy, or by contacting the third party.
...
Owner contact email: admin@mejoresresenas.com
...
Information collected automatically through this Application (or third-party services employed in this Application), which can include: the IP addresses or domain names of the computers utilized by the Users who use this Application, the URI addresses (Uniform Resource Identifier), the time of the request, the method utilized to submit the request to the server, the size of the file received in response, the numerical code indicating the status of the server&aposs answer (successful outcome, error, etc.), the country of origin, the features of the browser and the operating system utilized by the User, the various time details per visit (e.g., the time spent on each page within the Application) and the details about the path followed within the Application with special reference to the sequence of pages visited, and other parameters about the device operating system and/or the User&aposs IT environment.
...
Small piece of data stored in the User&aposs device.
